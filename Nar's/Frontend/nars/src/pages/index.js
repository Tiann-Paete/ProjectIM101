...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 text-neutral-800">
      <style jsx global>{`
        body {
      ...
      <main className="flex-grow">
        ...
        <section id="home" className="py-24 min-h-screen flex items-center">
          <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 text-center md:text-left mb-12 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Welcome to Nar's School Supplies</h1>
              <p className="text-xl mb-10">Your one-stop shop for all your educational needs</p>
              <button 
        ...
        {/* About Section */}
        <section id="about" className="py-24 min-h-screen flex items-center bg-gray-100">
          <div className="container mx-auto max-w-7xl px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-center text-orange-400">About Nar's</h2>
        ...
        <section id="contact" className="py-24 min-h-screen flex items-center bg-gray-100">
          <div className="container mx-auto max-w-7xl px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-orange-400">Ready to get started?</h2>
            <p className="text-xl mb-10">Contact us today to learn more about our products and services.</p>
