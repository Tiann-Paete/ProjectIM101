    ...
    <div className="container mx-auto p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-8">
        <div className="w-full md:w-1/2">
          ...
          <form className="space-y-4">
            ...
            <div className="flex gap-2">
              <select className="w-20 p-2 border rounded">
                <option>63+</option>
              </select>
              <input 
                name="phoneNumber" 
          ...
          <div className="flex space-x-4">
            <button 
              ...
              className={`p-2 border rounded flex items-center ${paymentMethod === 'GCash' ? 'border-blue-500' : ''}`}
            >
              <Image src="/ImageLogo/Gcash.png" alt="GCash" width={70} height={50} />
            </button>
            <button 
              onClick={() => setPaymentMethod('PayMaya')} 
              className={`p-2 border rounded flex items-center ${paymentMethod === 'PayMaya' ? 'border-blue-500' : ''}`}
            >
        ...
        <div className="w-full md:w-1/2">
          ...
          <button 
            onClick={placeOrder} 
            className="w-full bg-orange-500 text-white py-3 rounded-lg mt-8 hover:bg-orange-600 transition duration-300"
          >
            Place Order
          </button>
        </div>
